...
public class Parameters {
  ...
  public static long SCHEDULER_PERIOD = 1; // in milliseconds

  public static int TRANSACTIONS_PER_ITERATION = 10; // number of transactions need to be generated every iteration

  public static int ACCOUNT_GENERATION_PERIOD = 100; // 5 means one account per 5 seconds (if sheduler period is 1000 ms)
  ...
  public static String OUTPUT_FOLDER = System.getProperty("user.home") + "/sshGen/";
